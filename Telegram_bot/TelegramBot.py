...
bot = telegram.Bot(token='5980760504:AAE0uRAlyhJ5O5mvpYaXoAQ0Fxgwavdv2u8') #Replace TOKEN with your token string

from telegram.ext import Updater, CommandHandler, MessageHandler, Filters

updater = Updater(token='5980760504:AAE0uRAlyhJ5O5mvpYaXoAQ0Fxgwavdv2u8', use_context=True) #Replace TOKEN with your token string
